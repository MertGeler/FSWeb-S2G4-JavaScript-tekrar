...
function CemberinCevresi(cemberinYariCap) {
  return 2 * pi * cemberinYariCap;
}
...
function CemberinAlani(cemberinYariCap, pi) {
  return pi * Math.pow(cemberinYariCap, 2);
}
...
console.log("GÖREV 3A: En küçük sayı: " + enkucuk);
console.log("GÖREV 3A: En büyük sayı: " + enbuyuk);
...
console.log("GÖREV 3B: 3'ün tam katı olan sayılar: " + ucetambolunenler);
//3c çözümü:
...
console.log(
  "GÖREV 3C: 3'e tam bölünenlerin toplamı: " + ucebolunenlerintoplami
);
